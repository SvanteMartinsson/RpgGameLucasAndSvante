"""Render B128's battle skill menu (square grid + Esc cell)."""
...
def render(path: Path) -> None:
    ...
    # A full 4-skill loadout so the grid shows several cells + the Esc cell.
...
if __name__ == "__main__":
    ...
    name = sys.argv[1] if len(sys.argv) > 1 else "b128_skill_grid_after"
