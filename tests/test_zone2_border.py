...
class Zone2BorderTest(unittest.TestCase):
    ...
    def test_western_encounters_come_from_zone2_pool(self):
        ...
        # B42: burg_146 is the MÖRK SKOG pool (+ rare strangling_vine).
        # B138: hollow_worg joined the forest as a second rare.
        self.assertTrue(seen <= {"goblin_raider", "thornling", "razortusk_boar", "cave_bear",
                                 "dire_wolf", "treant", "broodmother_spider", "goblin_shaman",
                                 "strangling_vine", "hollow_worg"}, seen)
